...
perl Configure VC-WIN32 --prefix=c:\devBuilds\openssl
nmake
nmake install
...
nmake /f Makefile.vc mode=dll MACHINE=x86 WITH_SSL=dll SSL_PATH=C:\devBuilds\openssl WITH_ZLIB=dll ZLIB_PATH=C:\devBuilds\zlib
mkdir "C:\devBuilds\curl\include"
mkdir "C:\devBuilds\curl\lib"
mkdir "C:\devBuilds\curl\bin"

xcopy C:\devBuilds\src\curl\builds\libcurl-vc-x86-release-dll-ssl-dll-zlib-dll-ipv6-sspi\* C:\devBuilds\curl\ /s /i
